		...
		<div class="container skinny">
			<div class="columns">
				<div class="column-50 first">
					...
					<p class="header-cta-text" style="color:<?php echo $ctaText; ?>"><strong><?php the_field('footer_incentive_offer'); ?></strong></p>
					<a href="tel:<?php the_field('footer_cta_phone'); ?>" title="Call Today" class="btn"><?php the_field('footer_cta_phone'); ?></a>
				</div>
				<div class="column-50">
					<p class="header-cta-text" style="color:<?php echo $ctaText; ?>"><?php the_field('form_cta_copy'); ?></p>
	...
	<section id="page-footer" style="background-color:<?php echo $pageFooterBG; ?>">
		<div class="container">
			<div class="columns">
				<div class="column-50 first">
				<div id="head-logo">
                    <img src="/wp-content/uploads/2018/02/logo.png" class="custom-logo" alt="Hecht, Kleeger &amp; Damashek, P.C." style="max-width:300px;">
				</div>
				</div>
				<div class="column-50">
