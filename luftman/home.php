			...
			<div class="container_inner2 clearfix">
				...
				<div class="filter-container content_width_75">
                    ...
                    <div class="select-wrapper"> 
                                    ...
                                    echo '<option value="/blog/">All Posts</option>'; 
                                    foreach ( $terms as $term ) :
                                    echo '<option value="/category/' . $term->slug . '/' . '">' . $term->name . '</option>'; // ID of the category as an option value
                                    endforeach;
                                    echo '</select>';
                                endif;
                                ?>
